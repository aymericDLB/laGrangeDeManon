(function(a, b) { 'object' == typeof exports && 'object' == typeof module ? module.exports = b() : 'function' == typeof define && define.amd ? define([], b) : 'object' == typeof exports ? exports.Datepickk = b() : a.Datepickk = b() })(this, function() {
    return function(a) {
        function b(d) { if (c[d]) return c[d].exports; var e = c[d] = { i: d, l: !1, exports: {} }; return a[d].call(e.exports, e, e.exports, b), e.l = !0, e.exports }
        var c = {};
        return b.m = a, b.c = c, b.d = function(a, c, d) { b.o(a, c) || Object.defineProperty(a, c, { configurable: !1, enumerable: !0, get: d }) }, b.n = function(a) { var c = a && a.__esModule ? function() { return a['default'] } : function() { return a }; return b.d(c, 'a', c), c }, b.o = function(a, b) { return Object.prototype.hasOwnProperty.call(a, b) }, b.p = '', b(b.s = 0)
    }([function(a, b, c) {
        'use strict';
        ...
        function d(a) {
            ...
            function h() {
                [].slice.call(z.el.yearPicker.childNodes).forEach(function(a) { a.innerHTML = '\'' + (C + parseInt(a.getAttribute('data-year'))).toString().substring(2, 4) })
            }
            ...
            function c() {
                ...
                for (var b, c = 0; c < J; c++) {
                    ...
                    for (var e, f = 0; 42 > f; f++) {
                        ...
                        i.setAttribute('class', 'd-tooltip'), b.appendChild(e), b.appendChild(g), g.appendChild(h), g.appendChild(i), e.addEventListener(A, function(a) { ca && a.preventDefault() }), e.addEventListener('change', s)
                    }
            ...
            function i() {
                function a(a) {
                    [].slice.call(z.el.tables.querySelectorAll('[data-legend-id*="' + this.getAttribute('data-legend-id') + '"]')).forEach(function(b) { 'mouseover' == a.type ? b.classList.add('legend-hover') : b.classList.remove('legend-hover') })
                }
                for (var b = new Date(z.el.tables.childNodes[0].childNodes[0].getAttribute('data-date')), c = new Date(z.el.tables.childNodes[J - 1].childNodes[82].getAttribute('data-date')), d = W.filter(function(a) {
                    ...
                    }[].slice.call(z.el.legend.querySelectorAll('.d-legend-item')).forEach(function(b) { 0 > e.indexOf(b) && (b.removeEventListener('mouseover', a), b.removeEventListener('mouseout', a), z.el.legend.removeChild(b)) })
            }

            function j(a) { return 11 < a ? a -= 12 : 0 > a && (a += 12), a }
            ...
            function m() {
                if (B.forEach(function(a) {
                    ...
                    var a = new Date(C, D - 1, 1),
                        b = B.sort(function(c, a) { return c.getTime() - a.getTime() }),
            ...
            function n() {
                [].slice.call(z.el.querySelectorAll('.d-table input')).forEach(function(a) { a.checked = !1 }), [].slice.call(z.el.monthPicker.querySelectorAll('.current')).forEach(function(a) { a.classList.remove('current') }), [].slice.call(z.el.yearPicker.querySelectorAll('.current')).forEach(function(a) { a.classList.remove('current') })
            }
            ...
            function r(a, b) {
                a = new Date(a), a.setHours(0, 0, 0, 0);
                var c = z.el.querySelector('[data-date="' + a.toJSON() + '"]');
                c && (c.classList.remove('single'), c.checked && (c.checked = !1)), B = B.filter(function(b) { return b.getTime() != a.getTime() }), T && !b && T.call(a, !1)
            }
            ...
            function s() {
                ...
                if (a.classList.remove('single'), !ca) {
                    if (F && z.el.tables.classList.remove('before'), a.checked) {
                        if (G && B.length > G - 1) { var c = B.length; for (c; c > G - 1; c--) r(B[0]) }
                        if (F && B.length) { var d = z.el.querySelector('[data-date="' + B[0].toJSON() + '"]');!d && b > B[0] && z.el.tables.classList.add('before') }
                        B.push(b), K && z.hide()
                    } else F && 1 == B.length && B[0].getTime() == b.getTime() ? (q(b), a.classList.add('single')) : B = B.filter(function(a) { return a.getTime() != b.getTime() });
                    T && T.call(b, a.checked)
                }
            }

            function t(a) { a ? (F = !0, z.el.tables.classList.add('range')) : (F = !1, z.el.tables.classList.remove('range')) }

            function u(a) {
                z.inline || z.container !== document.body || document.body.classList.add('d-noscroll'), x(a);
                z.el.calendar.addEventListener(e(), function a() { z.el.classList.remove('d-show'), z.el.calendar.removeEventListener(e(), a) }), z.el.classList.add('d-show'), H.appendChild(z.el), I = !0, $ && (D = $.getMonth() + 1, C = $.getFullYear()), l()
            }

            function v() {
                document.body.classList.remove('d-noscroll');
                z.el.addEventListener(e(), function a() { z.el.parentNode.removeChild(z.el), I = !1, z.el.classList.remove('d-hide'), 'function' == typeof O && O.apply(z), z.el.removeEventListener(e(), a) }), z.el.classList.add('d-hide')
            }

            function w() {
                z.el.header.childNodes[0].addEventListener(A, p), z.el.header.childNodes[2].addEventListener(A, o), z.el.header.childNodes[1].childNodes[0].addEventListener(A, function() { z.el.monthPicker.classList.contains('d-show') ? z.el.monthPicker.classList.remove('d-show') : z.el.monthPicker.classList.add('d-show'), z.el.yearPicker.classList.remove('d-show') }), z.el.header.childNodes[1].childNodes[1].addEventListener(A, function() { h(), z.el.yearPicker.classList.contains('d-show') ? z.el.yearPicker.classList.remove('d-show') : z.el.yearPicker.classList.add('d-show'), z.el.monthPicker.classList.remove('d-show') }), z.el.button.addEventListener(A, v), z.el.overlay.addEventListener(A, function() { Q && z.hide() }), [].slice.call(z.el.monthPicker.childNodes).forEach(function(a) { a.addEventListener(A, function() { D = parseInt(this.getAttribute('data-month')), l(), z.el.monthPicker.classList.remove('d-show') }) }), [].slice.call(z.el.yearPicker.childNodes).forEach(function(a) { a.addEventListener(A, function() { C += parseInt(this.getAttribute('data-year')), l(), z.el.yearPicker.classList.remove('d-show') }) });
                var a = 0,
                    b = 0;
                z.el.calendar.addEventListener('touchstart', function(b) { a = b.changedTouches[0].clientX || b.originalEvent.changedTouches[0].clientX }), z.el.calendar.addEventListener('touchmove', function(c) { b = c.changedTouches[0].clientX - a || c.originalEvent.changedTouches[0].clientX - a, c.preventDefault() }), z.el.calendar.addEventListener('touchend', function() { 50 < b ? p() : -50 > b && o(), b = 0 })
            }

            function x(a) { for (var b in a) b in z && (z[b] = a[b]) }

            function y(a) { a = new Date(a), D = a.getMonth() + 1, C = a.getFullYear(), l() }
            ...
            var F = !1,
                ...
                ba = null,
                ca = !1;
            return z.show = u, z.hide = v, z.selectDate = q, z.unselectAll = function(a) { B.forEach(function(b) { r(b, a) }) }, z.unselectDate = r, Object.defineProperties(z, {
                    selectedDates: { get: function() { return B.sort(function(c, a) { return c.getTime() - a.getTime() }) } },
                    range: { get: function() { return F }, set: function(a) { t(a), a && (G = 2) } },
                    button: { get: function() { return L }, set: function(a) { L = 'string' == typeof a ? a : null, z.el.button.innerHTML = L ? L : '' } },
                    title: { get: function() { return M }, set: function(a) { M = 'string' == typeof a ? a : null, z.el.titleBox.innerText = M ? M : '' } },
                    lang: { get: function() { return S }, set: function(a) { a in E ? (S = a, b(), l()) : console.error('Language test not found') } },
                    weekStart: { get: function() { return null == ba ? E[S].weekStart : ba }, set: function(a) { 'number' == typeof a && -1 < a && 7 > a ? (ba = a, b(), l()) : console.error('weekStart must be a number between 0 and 6') } },
                    months: { get: function() { return J }, set: function(a) { 'number' == typeof a && 0 < a ? (J = a, b(), c(), l(), 1 == J ? z.el.classList.remove('multi') : z.el.classList.add('multi')) : console.error('months must be a number > 0') } },
                    isOpen: { get: function() { return I } },
                    closeOnSelect: { get: function() { return K }, set: function(a) { K = !!a } },
                    disabledDays: {
                    ...
                    disabledDates: { get: function() { return U.map(function(a) { return new Date(a) }) }, set: function(a) { a instanceof Array ? a.forEach(function(a) { a instanceof Date && U.push(new Date(a.getFullYear(), a.getMonth(), a.getDate()).getTime()) }) : a instanceof Date ? U = [new Date(a.getFullYear(), a.getMonth(), a.getDate()).getTime()] : !a && (U = []), l() } },
                    highlight: {
                    ...
                    onClose: { set: function(a) { O = a } },
                    onSelect: { set: function(a) { T = a } },
                    today: { get: function() { return Z }, set: function(a) { Z = !!a } },
                    daynames: { get: function() { return Y }, set: function(a) { Y = !!a, b() } },
                    fullscreen: { get: function() { return z.el.classList.contains('fullscreen') }, set: function(a) { a ? z.el.classList.add('fullscreen') : z.el.classList.remove('fullscreen') } },
                    locked: { get: function() { return ca }, set: function(a) { a ? (ca = !0, z.el.tables.classList.add('locked')) : (ca = !1, z.el.tables.classList.remove('locked')) } },
                    maxSelections: { get: function() { return G }, set: function(a) { G = 'number' != typeof a || F ? F ? 2 : null : a } },
                    onConfirm: { set: function(a) { 'function' == typeof a ? (P = a.bind(z), z.el.button.addEventListener(A, P)) : !a && (z.el.button.removeEventListener(A, P), P = null) } },
                    onNavigation: { set: function(a) { 'function' == typeof a ? N = a.bind(z) : !a && (N = null) } },
                    closeOnClick: { get: function() { return Q }, set: function(a) { Q = !!a } },
                    tooltips: { get: function() { var a = []; for (key in X) a.push({ date: new Date(parseInt(key)), text: X[key] }); return a }, set: function(a) { a instanceof Array ? a.forEach(function(a) { a.date && a.text && a.date instanceof Date && (X[new Date(a.date.getFullYear(), a.date.getMonth(), a.date.getDate()).getTime()] = a.text) }) : a instanceof Object ? a.date && a.text && a.date instanceof Date && (X[new Date(a.date.getFullYear(), a.date.getMonth(), a.date.getDate()).getTime()] = a.text) : !a && (X = []), l() } },
                    currentDate: { get: function() { return new Date(C, D - 1, 1) }, set: y },
                    setDate: { set: y },
                    startDate: { get: function() { return $ }, set: function(a) { a ? $ = new Date(a) : ($ = null, C = new Date().getFullYear(), D = new Date().getMonth() + 1), l() } },
                    minDate: { get: function() { return _ }, set: function(a) { _ = a ? new Date(a) : null, l() } },
                    maxDate: { get: function() { return aa }, set: function(a) { aa = a ? new Date(a) : null, l() } },
                    container: {
                    ...
                    inline: { get: function() { return R }, set: function(a) { a ? (R = !0, z.el.classList.add('inline')) : (R = !1, z.el.classList.remove('inline')) } }
                }),
                function() { z.el = document.createElement('div'), z.el.id = 'Datepickk', z.el.classList.add(g().type), z.el.innerHTML = f, z.el.calendar = z.el.childNodes[1], z.el.titleBox = z.el.childNodes[0], z.el.button = z.el.childNodes[3], z.el.header = z.el.calendar.childNodes[0], z.el.monthPicker = z.el.calendar.childNodes[1], z.el.yearPicker = z.el.calendar.childNodes[2], z.el.tables = z.el.calendar.childNodes[4], z.el.days = z.el.calendar.childNodes[3], z.el.overlay = z.el.childNodes[4], z.el.legend = z.el.childNodes[2], x(a), c(), b(), w(), R && u() }(), l(), Object.freeze(z)
        }
        /*!
         * Datepickk
        ...
        function e() {
            var a, b = document.createElement('fakeelement'),
                c = { animation: 'animationend', OAnimation: 'oanimationend', MozAnimation: 'animationend', WebkitAnimation: 'webkitAnimationEnd', "": 'MSAnimationEnd' };
            for (a in c)
        ...
        var f = '<div class="d-title"></div><div class="d-calendar"><div class="d-header"><i id="d-previous"></i><p><span class="d-month"></span><span class="d-year"></span></p><i id="d-next"></i></div><div class="d-month-picker"><div data-month="1">1</div><div data-month="2">2</div><div data-month="3">3</div><div data-month="4">4</div><div data-month="5">5</div><div data-month="6">6</div><div data-month="7">7</div><div data-month="8">8</div><div data-month="9">9</div><div data-month="10">10</div><div data-month="11">11</div><div data-month="12">12</div></div><div class="d-year-picker"><div data-year="-5"></div><div data-year="-4"></div><div data-year="-3"></div><div data-year="-2"></div><div data-year="-1"></div><div data-year="0"></div><div data-year="1"></div><div data-year="2"></div><div data-year="3"></div><div data-year="4"></div><div data-year="5"></div></div><div class="d-weekdays"></div><div class="d-tables"></div></div><div class="d-legend"></div><button class="d-confirm"></button><div class="d-overlay"></div>',
            g = function() {
                var a, b, c = { type: null, version: null },
                    d = navigator.userAgent,
                    e = d.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
                return (b = d.match(/(iphone|ipad)\s+OS\s+([\d+_]+\d+)/i) || [], /trident/i.test(e[1])) ? (a = /\brv[ :]+(\d+)/g.exec(d) || [], c.type = 'MSIE', c.version = parseInt(a[1]), c) : 'Chrome' === e[1] && (a = d.match(/\bOPR\/(\d+)/), null != a) ? 'Opera ' + a[1] : b[1] ? c = { type: 'iOS', version: b[2] } : (e = e[2] ? [e[1], e[2]] : [navigator.appName, navigator.appVersion, '-?'], null != (a = d.match(/version\/(\d+)/i)) && e.splice(1, 1, a[1]), c.type = e[0], c.version = parseInt(e[1]), c)
            };
        b.default = d
    }, function() {}])['default']
});
